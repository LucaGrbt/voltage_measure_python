...
class Ui_Calibration_Window(object):
    ...
    def setupUi(self, Calibration_Window):
        ...
        self.current_measure_display.setGeometry(QRect(40, 140, 221, 31))
        ...
        self.weight_instruction.setGeometry(QRect(30, 199, 241, 61))
        ...
        self.current_weight_input.setGeometry(QRect(40, 269, 221, 31))
        ...
        self.append_weight_voltage_pair.setGeometry(QRect(40, 320, 221, 23))
        ...
        self.gauge_finished.setGeometry(QRect(10, 360, 281, 31))
        ...
        self.plot_calibration_curve.setGeometry(QRect(50, 400, 201, 41))
        ...
        self.delete_last_calibration_data.setGeometry(QRect(10, 20, 281, 21))
        ...
        self.delete_warning.setGeometry(QRect(10, 50, 281, 46))
    ...
    def retranslateUi(self, Calibration_Window):
        ...
        self.current_voltage.setText(QCoreApplication.translate("Calibration_Window", u"Aktuelle Spannung [V]", None))
